      ...
      <div className="pd-main">
          ...
          <div className="pd-img-main-wrap">
            <div className="pd-badges">
              {Number(product.discountpercentage) > 0 && (
                <span className="pd-badge pd-badge-off">{product.discountpercentage}% OFF</span>
              )}
        ...
        <div className="pd-info">
          ...
          <div className="pd-cta-row">
            ...
            <button className="pd-btn-view" onClick={openCart}>View Cart</button>
          </div>

          <div className="pd-trust-row">
            <div className="pd-trust-item"><i className="fa-solid fa-truck-fast" /><span>Free Delivery ₹499+</span></div>
            <div className="pd-trust-item"><i className="fa-solid fa-rotate-left" /><span>7-Day Returns</span></div>
            <div className="pd-trust-item"><i className="fa-solid fa-shield-halved" /><span>Secure Payment</span></div>
          </div>
        </div>
      </div>
