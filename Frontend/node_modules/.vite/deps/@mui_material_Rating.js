...
var Rating = React31.forwardRef(function Rating2(inProps, ref) {
  const props = useDefaultProps2({
    name: "MuiRating",
    props: inProps
  });
  ...
  const [emptyValueFocused, setEmptyValueFocused] = React31.useState(false);
  const ownerState = {
    ...props,
    component,
    defaultValue,
